...
@REM git push -f https://github.com/Shuaiwen-Cui/Skillsets-MCU51.git main
git push -f https://github.com/Shuaiwen-Cui/Skillsets-MCU51.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Skillsets-MCU51.git
